...
%         while idx < 500
            ...
            D_te_prime = (D_te_1 - D_te_2) / delta_k;
%             krho_te_prev_2 = krho_te_prev;
%             krho_te_mid = krho_te - D_te / D_te_prime;
%             if krho_te_prev == krho_te_mid
%                 krho_te = krho_te_mid;
%                 break;
%             end
            krho_te_prev = krho_te;
...
%             variance = abs(krho_te - krho_te_prev);
%             if prev_variance == variance
%                 variance_idx = variance_idx + 1;
%             end
%             prev_variance = variance;

%             if krho_te_prev_2 == krho_te
%                 break;
%             end
        end
...
%         while idx < 0
            ...
            D_tm_prime = (D_tm_1 - D_tm_2) / delta_k;
%             krho_tm_prev_2 = krho_tm_prev;
%             krho_tm_mid = krho_tm - D_tm / D_tm_prime;
%             if krho_tm_prev == krho_tm_mid
%                 krho_tm = krho_tm_mid;
%                 break;
%             end
            krho_tm_prev = krho_tm;
