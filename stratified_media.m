function varargout = stratified_media(k0, krho, z, varargin)
...
%   Detailed explanation goes here
    ...
    elseif strcmp(varargin{1}, 'Superstrate')
        ...
        Zin_te = Zs_te ...
            .* (Zair_te + 1j * Zs_te .* tan(dielectric_kz * slab_length)) ...
            ./ (Zs_te + 1j * Zair_te .* tan(dielectric_kz * slab_length));
        Zin_tm = Zs_tm ...
            .* (Zair_tm + 1j * Zs_tm .* tan(dielectric_kz * slab_length)) ...
            ./ (Zs_tm + 1j * Zair_tm .* tan(dielectric_kz * slab_length));
