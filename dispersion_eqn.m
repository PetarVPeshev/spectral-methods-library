...
%   Detailed explanation goes here
    ...
    elseif strcmp(varargin{1}, 'Superstrate')
        ...
        Zl_te = Zs_te ...
            .* (Zair_te + 1j * Zs_te .* tan(slab_kz * slab_length)) ...
            ./ (Zs_te + 1j * Zair_te .* tan(slab_kz * slab_length));
        Zl_tm = Zs_tm ...
            .* (Zair_tm + 1j * Zs_tm .* tan(slab_kz * slab_length)) ...
            ./ (Zs_tm + 1j * Zair_tm .* tan(slab_kz * slab_length));
